...
public class EquipmentDAO {
    ...
    public boolean addEquipment(Equipment equipment) throws SQLException {
        String sql = "INSERT INTO equipment (equipment_name, condition_status, last_maintenance, " +
                     "next_maintenance, hours_used, equipment_type) VALUES (?, ?, ?, ?, ?, ?)";
        try (Connection conn = DBConnection.getConnection();
    ...
    public boolean updateEquipment(Equipment equipment) throws SQLException {
        String sql = "UPDATE equipment SET equipment_name = ?, condition_status = ?, " +
                     "last_maintenance = ?, next_maintenance = ?, hours_used = ?, " +
                     "equipment_type = ? WHERE equipment_id = ?";
