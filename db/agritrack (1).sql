...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Jun 14, 2025 at 03:56 PM
...
INSERT INTO `crops` (`crop_id`, `crop_name`, `planting_date`, `status`, `notes`, `image_path`) VALUES
(11, 'Potatoes', '2025-06-14', 'Germination', 'Tanam tepi pantai', 'uploads/1749886238717_tom.jpg');
...
INSERT INTO `equipment` (`equipment_id`, `equipment_name`, `condition_status`, `last_maintenance`, `next_maintenance`, `hours_used`, `equipment_type`, `created_at`, `updated_at`) VALUES
(6, 'A001', 'Excellent', '2025-06-12', '2025-09-12', 111, 'Tractor', '2025-06-14 07:33:45', '2025-06-14 07:33:45'),
(7, 'A002', 'Good', '2025-05-09', '2025-08-09', 0, 'Plow', '2025-06-14 07:34:13', '2025-06-14 07:34:24'),
(8, 'A003', 'Needs Maintenance', '2025-02-20', '2025-05-20', 0, 'Harvester', '2025-06-14 07:34:42', '2025-06-14 07:35:03'),
(9, 'A004', 'Out of Service', '2025-05-19', '2025-08-19', 0, 'Seeder', '2025-06-14 07:37:05', '2025-06-14 07:37:05');
...
('aqilmizwar42@gmail.com', '123456'),
('puyuhburung32@gmail.com', 'aqil0113'),
('wan@test.com', 'aqil0113'),
('wanaimi04@gmail.com', 'aimi2004');
...
('aqilmizwar42@gmail.com', 'Farmer Profile', 'Agronomist & Farm Owner', '+1 (555) 123-4567', 'Kuala Terengganu, Terengganu', '20 Acres', 'Corn, Soybeans, Wheat', '2025-06-14', NULL),
('wanaimi04@gmail.com', 'Your Name', 'Your Title', NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `crops`
  MODIFY `crop_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
